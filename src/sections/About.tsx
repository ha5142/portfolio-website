            ...
            <Card className="h-[320px] md:col-span-2 lg:col-span-1 overflow-hidden flex flex-col">
              ...
              <div className="flex-1 overflow-y-auto px-12 hide-scrollbar">
                 <ul className="list-disc space-y-3 text-sm text-gray-300">
                  <li>
                    <strong>Bachelor of Technology in CSE</strong> - <a href="https://www.srmist.edu.in/" target="_blank" rel="noopener noreferrer">SRM University</a>
                    <br />
                    <span className="text-gray-500">2023 - 2027</span>
                  </li>
                  <li>
                    <strong>High School - AISSCE</strong> - Vivekanand Memorial Public School, Raisinghnagar
                    <br />
