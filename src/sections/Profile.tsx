...
import YourFaceImage from "@/assets/images/Harsh-pic.png";
      ...
      <div className="container">
        ...
        <div className="max-w-lg mx-auto">
          ...
          <p className="mt-4 text-center text-white/60 md:text-lg">
           Aspiring Web Developer with a strong foundation in building dynamic, responsive applications. Enthusiastic about exploring Web3 technologies and decentralized solutions. Skilled in solving medium to hard Data Structures and Algorithms problems, 
           driven by a passion for continuous growth and problem-solving excellence.
          </p>
        </div>
